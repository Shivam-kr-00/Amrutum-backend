...
-- CreateEnum
CREATE TYPE "ConsultationStatus" AS ENUM ('BOOKED', 'STARTED', 'COMPLETED', 'PRESCRIPTION_GENERATED');
...
-- CreateIndex
CREATE UNIQUE INDEX "availability_slots_doctorId_startTime_key" ON "availability_slots"("doctorId", "startTime");
...
-- AddForeignKey
ALTER TABLE "bookings" ADD CONSTRAINT "bookings_patientId_fkey" FOREIGN KEY ("patientId") REFERENCES "profiles"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "consultations" ADD CONSTRAINT "consultations_bookingId_fkey" FOREIGN KEY ("bookingId") REFERENCES "bookings"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
